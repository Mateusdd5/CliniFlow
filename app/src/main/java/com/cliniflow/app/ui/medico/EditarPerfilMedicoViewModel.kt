...
class EditarPerfilMedicoViewModel : ViewModel() {
    ...
    fun salvar(nome: String, sobrenome: String, dataNascimento: String, sexo: String, especialidade: String) {
        ...
        viewModelScope.launch {
            val atualizado = atual.copy(
                ...
                sexo = sexo, especialidade = especialidade
            )
            usuarioRepository.atualizar(atualizado)
                .onSuccess { usuario = atualizado; salvoComSucesso = true; mensagem = "Perfil atualizado com sucesso." }
